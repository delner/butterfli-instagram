module Butterfli::Instagram::Jobs
  class GeographyRecentMedia < Butterfli::Jobs::StoryJob
    ...
    def get_stories
      raise ArgumentError, "Missing geography ID to fetch!" if args[:obj_id].nil?
      media_objects = self.client.geography_recent_media(args[:obj_id], min_id: args[:min_id])
